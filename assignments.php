        ...
        <div class="admin-page">
            ...
            <div class="content" style="display: block;box-sizing: border-box;">
                ...
                <div class="stc" style="grid-template-rows: repeat(auto-fit,300px);">
                    <?php
                    $qsub = "SELECT * FROM `assignment` WHERE `teacher_id`='".$_SESSION["teacher"]["teacher_id"]."';";
                    ...
                    ?>
                        <div class="sub">
                            ...
                            <h3 style="margin: 2px;text-align: center;"><?php echo "Mark Status : " .$rsub["assignment_marks_status"] ?></h3>
  

                            <button class="b" style="width: 100%;" onclick="window.location='manage_ass.php?ai=<?php echo $rsub['assignment_id']?>'">Manage</button>
                        </div>
                    <?php
                    }
                    ?>
